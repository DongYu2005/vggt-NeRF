...
def config_parser(cmd=None):
    ...
    # 🔥 新增以下参数以支持 VGGT 和训练控制
    parser.add_argument('--vggt_ckpt', type=str, default=None, help='path to vggt checkpoint')
    parser.add_argument('--freeze_vggt', type=str2bool, default=False, help='whether to freeze vggt')
    parser.add_argument('--val_check_interval', type=float, default=1.0, help='validation interval')
    # 添加这个新参数，类型是 int
    parser.add_argument('--check_val_every_n_epoch', type=int, default=1, help='perform val every n epochs')
    parser.add_argument('--num_workers', type=int, default=16, help='dataloader num_workers')

    ## blender flags
    parser.add_argument("--white_bkgd", action='store_true',
                        help='set to render synthetic data on a white bkgd (always use for dvoxels)')
    parser.add_argument('--scan', type=str, default=None, help='specific scan to finetune')
